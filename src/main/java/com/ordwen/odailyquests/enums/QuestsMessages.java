...
public enum QuestsMessages {
    ...
    QUESTS_IN_PROGRESS("quests_in_progress", "&eYou still have weekly quests to complete !"),
    ALL_QUESTS_ACHIEVED_CONNECT("all_quests_achieved_connect", "&aYou have completed all your weekly quests !"),
    QUESTS_RENEWED("quests_renewed", "&aYou have new weekly quests to complete !"),
    ...
    ALL_QUESTS_ACHIEVED("all_quests_achieved", "&aYou have finished all your weekly quests, well done !"),
